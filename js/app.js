...
//cri
    ...
    boton.addEventListener("click", function() {    
       if(conta == 1){
            ...
            document.getElementById("circulo2").style.borderColor = "transparent";
            document.getElementById("circulo3").style.borderColor = "transparent";
        }
       if(conta == 2){
            document.getElementById("circulo2").style.border = "2px solid green";
            document.getElementById("color").placeholder = "rojo";
            document.getElementById("circulo1").style.borderColor = "transparent";
            document.getElementById("circulo3").style.borderColor = "transparent";
        }
        if(conta == 3){
